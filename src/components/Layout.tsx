    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#121212]">
        <div className="text-center relative">
          ...
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 mb-6 relative z-10 font-heading tracking-wider">
            Saikoushik Nalubola
          </h1>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#121212]">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 p-3 bg-pink-600/80 text-white rounded-full shadow-lg shadow-pink-500/30 hover:bg-pink-500 transition-colors z-40 group"
