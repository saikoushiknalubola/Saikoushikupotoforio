      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-5">
            <div className="flex items-center space-x-3">
              <div className="anime-logo flex items-center justify-center w-12 h-12 rounded-lg relative overflow-hidden">
                ...
                <span className="relative z-10 text-white font-bold text-2xl font-heading tracking-wide">SN</span>
            ...
            <p className="text-sm text-gray-400 max-w-md font-light leading-relaxed tracking-wide">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-3 tracking-wide">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a 
                    href={link.href} 
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-5 font-light leading-relaxed tracking-wide">
            ...
            <a 
              ...
              className="inline-flex items-center px-4 py-2 rounded-md bg-gradient-to-r from-pink-600 to-purple-600 text-white hover:from-pink-500 hover:to-purple-500 transition-all duration-300 font-medium text-sm"
            >
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p className="font-light tracking-wide mb-4 md:mb-0">© {currentYear} Saikoushik Nalubola. All rights reserved.</p>
