...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        {/* Content */}
        <div className="w-full lg:w-2/3 space-y-4 lg:space-y-6 text-center lg:text-left">
          {/* Tags */}
          <div className={`flex flex-wrap justify-center lg:justify-start gap-2 mb-6 lg:mb-8 transform transition-all duration-700 ${isSocialsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="overflow-hidden">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight leading-tight">
              ...
              <div className={`relative transform transition-all duration-1000 ${isNameVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 font-bold animate-pulse-glow">
                  Saikoushik Nalubola
                </span>
                <span className="inline-block animate-pulse ml-1 -mb-2 text-purple-400 text-5xl lg:text-6xl">|</span>
              </div>
            </h1>
          </div>
          ...
          {/* Description */}
          <div className="overflow-hidden">
            <p className={`text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0 font-light transform transition-all duration-700 ${isDescVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Transforming ideas into impactful AI-driven solutions with a passion for innovation and sustainability
            </p>
          </div>
          
          {/* Decorative element */}
          <div className={`hidden lg:block h-1 w-24 bg-gradient-to-r from-pink-500 to-purple-500 my-4 lg:my-6 transform transition-all duration-700 ${isDescVisible ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'}`}></div>
          
          {/* Social Media */}
          <div className={`flex justify-center lg:justify-start gap-4 sm:gap-6 mt-6 lg:mt-8 transform transition-all duration-700 ${isSocialsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <a href="https://saikoushiknalubola.netlify.app/" target="_blank" rel="noopener noreferrer" 
               className="social-button group">
              <Globe className="w-5 h-5 text-white group-hover:text-pink-400" />
            </a>
          </div>
          
          {/* CTA Buttons */}
          <div className={`flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4 pt-4 lg:pt-6 transform transition-all duration-700 ${isButtonsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <a href="#projects" className="anime-button-primary group px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold">
              <span>
                View Projects
                <svg className="w-4 sm:w-5 h-4 sm:h-5 ml-2 inline-block transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </span>
            </a>
            <a href="#contact" className="anime-button-secondary group px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold">
        ...
        {/* Profile Image */}
        <div className={`mt-8 lg:mt-0 relative transform transition-all duration-1000 ${isProfileVisible ? 'opacity-100 translate-y-0 rotate-0' : 'opacity-0 translate-y-8 rotate-6'}`}>
          <div className="relative animate-float">
            ...
            <div className="relative rounded-2xl overflow-hidden glass-card p-1.5 border border-white/20">
              ...
              <div className="relative overflow-hidden rounded-xl">
                <Avatar className="w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-xl">
                  <AvatarImage 
                    src="/lovable-uploads/1466490d-7b5c-4b9c-9b5e-584004601ca5.png" 
                    alt="Saikoushik Nalubola" 
                    className="object-cover"
                  />
                  <AvatarFallback className="text-2xl sm:text-4xl bg-gradient-to-br from-pink-600 to-purple-700 text-white font-bold">SN</AvatarFallback>
                </Avatar>
            ...
            <div className="absolute -bottom-2 -right-2 p-1.5 rounded-full bg-green-500 animate-pulse">
              <span className="block w-4 sm:w-5 h-4 sm:h-5 rounded-full bg-gradient-to-r from-green-400 to-green-500 border-2 border-[#121212]"></span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-6 lg:bottom-10 left-1/2 transform -translate-x-1/2 animate-float">
        <div className="w-5 lg:w-6 h-8 lg:h-10 rounded-full border-2 border-pink-500/70 flex justify-center p-1">
