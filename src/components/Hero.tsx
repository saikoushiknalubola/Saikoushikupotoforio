...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen pt-20 pb-20 px-4 flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-[#0a0a0a] via-[#121212] to-[#1a1a2e]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-56 right-4 sm:right-8 w-5 h-5 sm:w-7 sm:h-7 opacity-15 animate-float" style={{ animationDelay: '2s' }}>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto w-full">
        ...
        <div className="mb-8 sm:mb-10 relative">
          ...
          <div className="relative bg-gradient-to-br from-[#F4E4BC] via-[#E8D5A3] to-[#D4C085] text-black p-4 sm:p-6 rounded-2xl border-4 border-amber-900 shadow-2xl transform rotate-1 hover:rotate-0 transition-all duration-700 max-w-xs sm:max-w-sm mx-auto hover:scale-105 group" style={{ fontFamily: "'Pirata One', cursive" }}>
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full mx-auto border-4 border-amber-900 shadow-xl object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute -top-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-red-600 to-red-700 rounded-full flex items-center justify-center border-2 border-white shadow-lg animate-bounce">
                  <Crown className="text-yellow-400 w-3 h-3 sm:w-4 sm:h-4" />
                </div>
                <div className="absolute -bottom-1 -left-1 w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                  <Trophy className="text-yellow-300 w-2.5 h-2.5 sm:w-3 sm:h-3" />
                </div>
              </div>
            </div>
            
            <div className="space-y-2">
              <div className="text-lg sm:text-xl font-black mb-2 tracking-wider text-red-800">WANTED</div>
              <div className="text-xl sm:text-2xl font-black leading-tight mb-2 bg-gradient-to-r from-red-700 to-orange-700 bg-clip-text text-transparent">
                SAIKOUSHIK NALUBOLA
              </div>
              <div className="text-sm sm:text-base font-bold text-blue-800 mb-2">AI ENGINEER & ENTREPRENEUR</div>
              <div className="text-lg sm:text-xl font-black text-red-600 mb-2">BOUNTY: ∞ BERRIES</div>
              <div className="text-xs sm:text-sm font-semibold text-gray-700">DEAD OR ALIVE</div>
              <div className="text-xs sm:text-sm font-medium text-gray-600 mt-3 italic leading-relaxed">
                "A visionary developer inspired by epic adventures, determined to revolutionize technology"
              </div>
              
              {/* Status badges */}
              <div className="flex justify-center space-x-2 mt-3">
                <span className="px-2 py-0.5 bg-green-600 text-white text-xs font-bold rounded-full">ACTIVE</span>
                <span className="px-2 py-0.5 bg-orange-600 text-white text-xs font-bold rounded-full">DANGEROUS</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`mb-8 transform transition-all duration-1000 delay-500 ${
          ...
          <div className="relative inline-block">
            <p className="text-xl sm:text-2xl md:text-3xl font-bold text-orange-400 jp-text mb-4 min-h-[2.5rem] sm:min-h-[3rem] flex items-center justify-center">
              {typedText}
            ...
            {showKingQuote && (
              <div className="animate-fade-in">
                <p className="text-base sm:text-lg md:text-xl text-gray-300 italic font-bold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent animate-pulse-glow">
                  "{kingQuote}"
                </p>
        ...
        <div className={`mb-12 transform transition-all duration-1000 delay-700 ${
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed mb-8 px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-8">
              <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 p-4 rounded-xl border border-red-500/30 hover:scale-105 transition-transform duration-300">
                ...
                <h3 className="font-bold text-red-400 mb-2 text-base">AI Mastery</h3>
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 p-4 rounded-xl border border-blue-500/30 hover:scale-105 transition-transform duration-300">
                ...
                <h3 className="font-bold text-blue-400 mb-2 text-base">Full-Stack Power</h3>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-4 rounded-xl border border-purple-500/30 hover:scale-105 transition-transform duration-300 sm:col-span-2 lg:col-span-1">
                ...
                <h3 className="font-bold text-purple-400 mb-2 text-base">Entrepreneurial Spirit</h3>
        ...
        <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 transform transition-all duration-1000 delay-1000 ${
          ...
          <a
            href="#about"
            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white font-bold rounded-xl hover:from-orange-500 hover:to-red-500 transition-all duration-300 hover:scale-110 shadow-2xl shadow-orange-500/40 inline-flex items-center justify-center space-x-3 min-w-[200px] text-base"
          >
          ...
          <a
            href="#projects"
            className="w-full sm:w-auto px-8 py-4 border-3 border-blue-500 text-blue-300 font-bold rounded-xl hover:bg-blue-500/10 transition-all duration-300 hover:scale-110 inline-flex items-center justify-center space-x-3 min-w-[200px] text-base"
          >
